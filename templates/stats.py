def get_stats_card_svg(stats, color="#00FFAA"):
  ...
  <rect width="450" height="200" rx="15" class="s-card-bg"/>
  
  <defs>
    <linearGradient id="s-grad-bg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="var(--s-accent)" stop-opacity="0.07"/>
      <stop offset="100%" stop-color="var(--s-accent)" stop-opacity="0"/>
    </linearGradient>
  </defs>
  <rect width="450" height="200" rx="15" fill="url(#s-grad-bg)"/>

  <g class="s-grid">
    <path d="M 0 100 L 450 100" />
    <path d="M 225 0 L 225 200" />
  </g>
